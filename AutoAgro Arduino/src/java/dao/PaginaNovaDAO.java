 ...
 * @author Carlos
 */
public class PaginaNovaDAO {
    
    public static void inserir(Rotina rotina, int idALimentador) throws SQLException {
...
"                     values (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public static List<Rotina> getLista(int idAlimentador) throws SQLException {
